...
urlpatterns = [
    ...
    path('get-disciplinas/<str:aluno_id>/', views.get_disciplinas, name='get_disciplinas'),
    path('get-user-info/<int:user_id>/', views.get_user_info, name='get_user_info'),
    path('set-user-info/<int:user_id>/', views.set_user_info, name='set_user_info'),
    path('set-relatorio/', views.set_relatorio, name='set_relatorio'),
    path('get-relatorio/<int:relatorio_id>', views.get_relatorio, name='get_relatorio'),
]